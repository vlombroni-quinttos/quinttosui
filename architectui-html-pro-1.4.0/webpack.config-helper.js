...
module.exports = (options) => {
  ...
  let webpackConfig = {
    context: __dirname,   // fija el contexto al dir del config, independiente de process.cwd()
    ...
    entry: {
      ...
      desempeno_actitudinal: "./src/scripts-init/desempeno-actitudinal.js",
  ...
  if (options.isProduction) {
    webpackConfig.entry = [
      ...
      "./src/scripts-init/desempeno-actitudinal.js",
    ...
    webpackConfig.devServer = {
      port: options.port,
      contentBase: dest,
      historyApiFallback: false, // MPA — cada .html es un archivo real, no SPA routing
      writeToDisk: true,
