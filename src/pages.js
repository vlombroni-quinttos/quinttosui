const pages = [
  ...
  {
    output: "./dashboards-home-docente.html",
    content: {
      title: "Home Docente",
      description: "Vista principal para el rol Docente — resumen de cursos asignados y acceso rápido a calificaciones.",
      heading_icon: "pe-7s-study icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/dashboards/home-docente.hbs",
  },
  {
    output: "./dashboards-home-preceptor.html",
    content: {
      title: "Home Preceptor",
      description: "Vista principal para el rol Preceptor — resumen de cursos asignados y acceso rápido a calificaciones.",
      heading_icon: "pe-7s-study icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/dashboards/home-preceptor.hbs",
  },
  // Pages
  ...
  {
    output: "./apps-desempeno-actitudinal.html",
    content: {
      title: "Desempeño Actitudinal",
      description: "Evaluación de desempeño actitudinal de alumnos por período.",
      heading_icon: "pe-7s-note2 icon-gradient bg-mixed-hopes",
    },
    template: "./src/DemoPages/applications/desempeno-actitudinal.hbs",
  },
  {
  ...
  {
    output: "./apps-templates-tables.html",
    content: {
      title: "Templates",
      description: "Page templates for data-heavy layouts — Tables, Forms, etc.",
    },
    template: "./src/DemoPages/applications/templates-tables.hbs",
  },

  // Foundations

  {
    output: "./foundations-typography.html",
    content: {
      title: "Typography",
      description: "Type scale — font sizes, weights and line heights used across the product.",
      heading_icon: "pe-7s-note icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/foundations/typography.hbs",
  },
  {
    output: "./foundations-color.html",
    content: {
      title: "Color",
      description: "Full color palette — core theme and semantic color scales.",
      heading_icon: "pe-7s-gleam icon-gradient bg-mean-fruit",
    },
    template: "./src/DemoPages/foundations/color.hbs",
  },
  {
    output: "./foundations-radius.html",
    content: {
      title: "Radius",
      description: "Corner radius scale — from sharp to fully rounded.",
      heading_icon: "pe-7s-arc icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/foundations/radius.hbs",
  },
  {
    output: "./foundations-spacings.html",
    content: {
      title: "Spacings",
      description: "Spacing scale — from tight micro gaps to large layout gaps.",
      heading_icon: "pe-7s-expand2 icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/foundations/spacings.hbs",
  },
  {
    output: "./foundations-tokens.html",
    content: {
      title: "Tokens",
      description: "Design tokens — primitivos y semánticos del sistema de diseño.",
      heading_icon: "pe-7s-config icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/foundations/tokens.hbs",
  },
  ...
  // UI Elements
  {
    ...
    content: {
      ...
      description:
        "The standard buttons feature fully rounded corners — the default button style across the theme.",
      heading_icon: "pe-7s-plane icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/elements/buttons/standard.hbs",
  },
  {
    output: "./elements-buttons-special.html",
    content: {
      title: "Special Buttons",
      description:
        "Specialized buttons for unique interaction patterns: FABs, export actions, and file attachments.",
      heading_icon: "pe-7s-plane icon-gradient bg-tempting-azure",
    },
    template: "./src/DemoPages/elements/buttons/special-buttons.hbs",
  },
  {
    output: "./elements-buttons-icon.html",
    content: {
      title: "Icon Buttons",
      description:
    ...
    template: "./src/DemoPages/elements/buttons/icon-buttons.hbs",
  },
  {
  ...
  {
    output: "./elements-dot-badges.html",
    content: {
      title: "Dot Badges",
      description:
        "Notification badges placed on icons to indicate counts or activity.",
      heading_icon: "pe-7s-voicemail icon-gradient bg-arielle-smile",
    },
    template: "./src/DemoPages/elements/dot-badges.hbs",
  },
  {
  ...
  },
  {
    ...
    content: {
      title: '<a href="https://fonts.google.com/icons?icon.style=Rounded" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">Material Icons <span style="font-size:.75em;vertical-align:middle;opacity:.6;">↗</span></a>',
      description: "",
  ...
  {
    output: "./elements-navigation-bars.html",
    content: {
      title: "Navigation Bars",
      description:
        "Side and top navigation bars for application layouts.",
      heading_icon: "pe-7s-rocket icon-gradient bg-mean-fruit",
    },
    template: "./src/DemoPages/elements/navigation-bars.hbs",
  },
  {
  ...
  {
    output: "./elements-avatars.html",
    content: {
      title: "Avatars",
      description:
        "Avatar components for displaying users — initials or photo, in small, medium and large sizes.",
      heading_icon: "pe-7s-users icon-gradient bg-plum-plate",
    },
    template: "./src/DemoPages/elements/avatars.hbs",
  },
  ...
  {
    output: "./widgets-color-picker.html",
    content: {
      title: "Color Picker",
      description:
        "An interactive color picker widget with preset swatches and a custom HSV color selector.",
      heading_icon: "pe-7s-paint icon-gradient bg-plum-plate",
    },
    template: "./src/DemoPages/dashboard-widgets/color-picker.hbs",
  },
